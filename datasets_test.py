...
class AgoraFaceDataset_test(Dataset):
    def __init__(self, image_size, scene_size, scale, trans_scale=0, split='val'):
        ...
        if split=='val':
            self.scene_folder = '/mnt2/PhD-Marcel/tests/TRUST/FAIR_benchmark/validation_set/full_image'
            self.kpt_folder = '/mnt2/PhD-Marcel/tests/TRUST/FAIR_benchmark/validation_set/crop-lmks'
            datafile = '/mnt2/PhD-Marcel/tests/TRUST/FAIR_benchmark/validation_set/validation_crop_files.txt'
...
class FFHQFaceDataset(Dataset):
    def __init__(self, image_size, scene_size, scale, trans_scale=0, split='val'):
        ...
        self.scene_folder = '/home/ext10812/TRUST/FFHQ/ffhq-val'
        self.kpt_folder = '/home/ext10812/TRUST/FFHQ/ffhq-val-lmks'
        datafile = '/home/ext10812/TRUST/FFHQ/ffhq_val_list.csv'
    ...
    def __getitem__(self, idx):
        image_path = self.data_lines[idx]
        image_name = image_path.split('/')[-1][:-4]
        scene_path = os.path.sep.join([self.scene_folder, image_name + '.png'])
        kpt_path = os.path.sep.join([self.kpt_folder, image_name + '.npy'])
