...
ffhq_data = pd.read_csv('/Users/nishtman/Desktop/GPU_output/OFIQ_CSV_scalar/scaled_ffhq_predicted_images.csv')
lfw_data = pd.read_csv('/Users/nishtman/Desktop/GPU_output/OFIQ_CSV_scalar/scaled_lfw_predicted_images.csv')
stylegan_data = pd.read_csv('/Users/nishtman/Desktop/GPU_output/OFIQ_CSV_scalar/scaled_ffhq_Style_GAN_predicted_images.csv')
lfw_hyperparameter_data = pd.read_csv('/Users/nishtman/Desktop/GPU_output/OFIQ_CSV_scalar/scaled_lfw_Hyperparameter_predicted_images.csv')
...
for feature, feature_display in zip(features, features_display):
    ...
    plt.title(f'OFIQ Feature Distribution for predicted_images (With Lighting) - {feature_display}')
...
# Print peak density table with new title
if not peak_density_df.empty:
    print("\n📊 OFIQ Feature Distribution for predicted_images (With Lighting)")
