...
fixed_dict = {
    # FLAME
    'topology_path': '/home/ext10812/TRUST/data/FLAME/geometry/head_template.obj',
    'flame_model_path': '/home/ext10812/TRUST/data/FLAME/geometry/generic_model.pkl',
    'flame_lmk_embedding_path': '/home/ext10812/TRUST/data/FLAME/geometry/landmark_embedding.npy',

    'BFM_tex_path': './data/FLAME_albedo_from_BFM.npz',
    'BalanceAlb_tex_path': '/home/ext10812/TRUST/data/BalanceAlb_model.npz',
    'lightprobe_normal_path': '/home/ext10812/TRUST/data/lightprobe_normal_images.npy',
    'lightprobe_albedo_path': '/home/ext10812/TRUST/data/lightprobe_albedo_images.npy',
...
config_test = {
    ...
    'pretrained_modelpath_flame': '/home/ext10812/TRUST/data/DECA/data/deca_model.tar',
    'pretrained_modelpath_status': '',
    'savefolder': '/home/ext10812/TRUST/ffhq_outputs',
...
if __name__ == '__main__':
    ...
    if args.test_folder !='':
        ...
        trust.test(return_params=False)
...
if __name__ == '__main__':
    ...
    if args.test_folder !='':
        ...
        num_samples = 1000  # %
        with tqdm(total=num_samples, desc="Processing", unit="sample") as pbar:
            trust.test(return_params=False)  # main funcation
            pbar.update(1)  # 
