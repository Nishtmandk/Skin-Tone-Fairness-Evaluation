...
for space, column in color_spaces.items():
    ...
    for idx, (dataset_name, file_path) in enumerate(files.items()):
        ...
        if column in df.columns:
            ...
            plt.title(f"{dataset_name} (Albedo)", fontsize=12)
    ...
    plt.suptitle(f"Evaluation of Bias Across 4 Datasets in {space} Color Space for Albedo Images", 
...
plt.title("Evaluation of Bias Across Color Spaces and Datasets for Albedo Images", fontsize=14)
